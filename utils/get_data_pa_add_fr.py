# -*- coding: utf-8 -*-
"""
Created on Mon Nov  2 23:36:58 2020
...
#####################################################3
def get_data_pa_add_fr(file_path, files):
    [
    pa_id,
    ###
    ###
    ...
    for file in files:
        ...
        ###
        worksheet = workbook['Poultry  Agents']
        print(f'File: {file} ...')
        print('Sheet: Additional Info ...')   
        prod_cycle2018_obj=worksheet['D5']
        prod_cycle2017_obj=worksheet['E5']
        prod_cycle2016_obj=worksheet['F5']       
        num_chicks_sold_farm2018_obj=worksheet['E10']
        num_chicks_sold_gov_agent2018_obj=worksheet['F10']
        num_chicks_sold_trader2018_obj=worksheet['G10']
        num_chicks_sold_vill_agents2018_obj=worksheet['H10']
        num_chicks_sold_other2018_obj=worksheet['I10']
        num_chicks_sold_total2018_obj=worksheet['D10']       
        turn_over_farm2018_obj=worksheet['E11']
        turn_over_gov_agent2018_obj=worksheet['F11']
        turn_over_trader2018_obj=worksheet['G11']
        turn_over_vill_agents2018_obj=worksheet['H11']
        turn_over_other2018_obj=worksheet['I11']
        turn_over_total2018_obj=worksheet['D11']       
        sold_to_unique_farmers2018_obj=worksheet['G14']       
        num_chicks_sold_farm2017_obj=worksheet['E18']
        num_chicks_sold_gov_agent2017_obj=worksheet['F18']
        num_chicks_sold_trader2017_obj=worksheet['G18']
        num_chicks_sold_vill_agents2017_obj=worksheet['H18']
        num_chicks_sold_other2017_obj=worksheet['I18']
        num_chicks_sold_total2017_obj=worksheet['D18']       
        turn_over_farm2017_obj=worksheet['E19']
        turn_over_gov_agent2017_obj=worksheet['F19']
        turn_over_trader2017_obj=worksheet['G19']
        turn_over_vill_agents2017_obj=worksheet['H19']
        turn_over_other2017_obj=worksheet['I19']
        turn_over_total2017_obj=worksheet['D19']       
        sold_to_unique_farmers2017_obj=worksheet['G22']       
        num_chicks_sold_farm2016_obj=worksheet['E26']
        num_chicks_sold_gov_agent2016_obj=worksheet['F26']
        num_chicks_sold_trader2016_obj=worksheet['G26']
        num_chicks_sold_vill_agents2016_obj=worksheet['H26']
        num_chicks_sold_other2016_obj=worksheet['I26']
        num_chicks_sold_total2016_obj=worksheet['D26']     
        turn_over_farm2016_obj=worksheet['E27']
        turn_over_gov_agent2016_obj=worksheet['F27']
        turn_over_trader2016_obj=worksheet['G27']
        turn_over_vill_agents2016_obj=worksheet['H27']
        turn_over_other2016_obj=worksheet['I27']
        turn_over_total2016_obj=worksheet['D27']     
        sold_to_unique_farmers2016_obj=worksheet['G30']
        ###
