...
import excel "$output\assessment_result_PAs.xlsx", sheet("PAs") firstrow clear


foreach x of varlist  /*
*/ pa_id   /*
*/ name_assessor   /*
*/ start_time-year_estabilished   /*
*/ avail_water-agency_lender_type   /*
*/ informal_access_loan   /*
*/ informal_lender_type   /*
*/ finance_challenge1- finance_challenge_other {
replace `x'="." if `x'==""
...
egen num_total = rsum(num_chicks_sold_farm num_chicks_sold_gov_agent num_chicks_sold_trader num_chicks_sold_vill_agents num_chicks_sold_other)
egen sales_total = rsum(turn_over_farm turn_over_gov_agent turn_over_trader turn_over_vill_agents turn_over_other)
...
save "$output\assessment_result_PAs_long.dta", replace

reshape wide

save "$output\assessment_result_PAs_wide.dta", replace
